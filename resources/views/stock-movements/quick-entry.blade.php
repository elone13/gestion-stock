...
<head>
    ...
    <title>Entrée Rapide de Stock</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4"><i class="fas fa-arrow-down me-2"></i>Entrée Rapide de Stock</h1>
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Ajouter du Stock</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="reason" name="reason" value="{{ old('reason') }}" placeholder="Réception, achat, etc.">
                            </div>
                        </div>
                    </div>
